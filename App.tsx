...
import { Music, Play, Calendar, MapPin, Mail, Youtube, User, Disc3, Radio } from 'lucide-react';
...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-white">JNSP</span>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              <a href="#home" className="text-white/80 hover:text-white transition-colors">Accueil</a>
              <a href="#music" className="text-white/80 hover:text-white transition-colors">Musique</a>
              <a href="#events" className="text-white/80 hover:text-white transition-colors">Événements</a>
        ...
        <div className="relative text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a 
              ...
              className="group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center space-x-2 shadow-xl"
            >
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-purple-300 font-semibold">Nouveau Single</span>
                </div>
      ...
      {/* Events Section */}
      <section id="events" className="py-20 px-6 bg-black/10">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            ...
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-purple-300 font-semibold">Événement à venir</span>
                </div>
      ...
      <section id="about" className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-black/20 backdrop-blur-lg rounded-3xl border border-white/10 p-8 md:p-12">
            <div className="flex items-center justify-center mb-8">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full blur-lg opacity-60"></div>
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-xl text-purple-300 font-semibold">DJ & Producteur Musique Électronique</p>
              ...
              <div className="pt-8">
                <p className="text-white/60 mb-4">Retrouvez JNSP sur :</p>
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                  <a 
                    href="https://music.youtube.com/channel/UCFAKDiOFbZkd9jhMRYbP6NQ?feature=shared"
                    target="_blank"
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-6 bg-black/10">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
          ...
          <div className="bg-black/20 backdrop-blur-lg rounded-3xl border border-white/10 p-8 md:p-12 text-center">
            <div className="flex items-center justify-center mb-8">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full blur-lg opacity-60"></div>
                <div className="relative bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-full">
            ...
            <a 
              ...
              className="inline-flex items-center space-x-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl"
            >
      ...
      <div className="fixed top-32 left-10 text-white/10 animate-bounce delay-300 pointer-events-none">
        <Radio className="h-8 w-8" />
      </div>
      <div className="fixed bottom-32 right-10 text-white/10 animate-bounce delay-700 pointer-events-none">
        <Disc3 className="h-6 w-6" />
      </div>
      <div className="fixed top-1/2 left-6 text-white/10 animate-bounce delay-500 pointer-events-none">
        <Play className="h-5 w-5" />
      </div>
    </div>
  );
